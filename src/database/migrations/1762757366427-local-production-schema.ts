...
export class LocalProductionSchema1762757366427 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "local_production" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "gross_quantity" numeric(10,2) NOT NULL, "consumed_quantity" numeric(10,2) NOT NULL, "total_quantity" numeric(10,2) NOT NULL, CONSTRAINT "PK_fdd4986d7d48f9507f50efac80b" PRIMARY KEY ("id"))`);
